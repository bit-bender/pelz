...
#define DER_ENCODE_PELZ_MSG_BASIC_TEST             0x00
#define DER_ENCODE_PELZ_MSG_NULL_MSG_IN_TEST       0x01
#define DER_ENCODE_PELZ_MSG_NULL_OUT_BUF_TEST      0x02

// test_der_decode_pelz_asn1_msg_helper() test select options
#define DER_DECODE_PELZ_MSG_BASIC_TEST             0x00
#define DER_DECODE_PELZ_MSG_NULL_BYTES_IN_TEST     0x01
#define DER_DECODE_PELZ_MSG_EMPTY_BYTES_IN_TEST    0x02
#define DER_DECODE_PELZ_MSG_NEG_BYTES_IN_LEN_TEST  0x03

// test_parse_pelz_asn1_msg_helper() test select options
#define PARSE_PELZ_MSG_BASIC_TEST                  0x00
#define PARSE_MOD_PELZ_MSG_TYPE_TAG_TEST           0x01
#define PARSE_MOD_PELZ_MSG_MSG_TYPE_VAL_LO_TEST    0x02
#define PARSE_MOD_PELZ_MSG_MSG_TYPE_VAL_HI_TEST    0x03
#define PARSE_MOD_PELZ_MSG_REQ_TYPE_VAL_LO_TEST    0x04
#define PARSE_MOD_PELZ_MSG_REQ_TYPE_VAL_HI_TEST    0x05
#define PARSE_MOD_PELZ_MSG_KEY_ID_TAG_TEST         0x06
#define PARSE_MOD_PELZ_MSG_DATA_TAG_TEST           0x07
#define PARSE_MOD_PELZ_MSG_STATUS_TAG_TEST         0x08
